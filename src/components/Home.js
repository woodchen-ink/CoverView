    ...
    return (
        <div className="bg-gray-50">
            ...
            <div className="md:my-32  my-10 mx-auto">
                ...
                <div className="md:w-10/12 mx-auto flex flex-col ">
                    ...
                    <div className="flex md:flex-row flex-col mx-auto justify-center my-10 mx-auto">
                        ...
                        <div className="m-10 p-10 bg-white rounded-xl shadow-xl shadow-gray-100 flex flex-col  md:w-4/12 ">
                            ...
                            <p className="text-2xl md:text-left text-center text-gray-700">每天都有大概 <span className="font-bold">700 万</span> 的博客文章发表。而随着新时代博客工具的兴起，这一数字只会有增无减。</p>
                        </div>
                        ...
                        <div className="m-10 p-10 bg-white rounded-xl shadow-xl shadow-gray-100 flex  flex-col  md:w-4/12 ">
                            ...
                            <p className="text-2xl md:text-left text-center text-gray-700">一张好的封面图片可以带来 <span className="font-bold">更高的转换率</span> 而不是一张随意的图片库图片。</p>
                        </div>
                ...
                <h2 className="md:text-5xl text-3xl md:w-1/2 mx-auto mt-32 font-bold font-Anek text-center text-gray-700">使用 coverview，您可以在以下时间内创建封面图像: <span className="text-indigo-400">几秒内</span>.</h2>
                <div className="md:w-8/12 my-20 flex md:flex-row flex-col mx-auto">
                    ...
                    <div className="flex flex-col md:w-1/3 mx-10">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-2xl my-2 font-semibold font-Inter text-gray-600">自定义颜色、字体、图标和图案</p>
                        </div>
                ...
                <div className="md:w-8/12 mx-auto pt-24 p-4">
                    ...
                    <Link to="/editor" >
                        <button className="flex mx-auto my-4 hover:translate-x-2 duration-300 bg-gray-700  rounded-full px-6 text-white text-xl font-Inter font-semibold p-4">免费试用！立即试用 &rarr;</button>
                    </Link>
                </div>
